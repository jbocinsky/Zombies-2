...
public class UpgradeMenu extends MouseAdapter {
	...
	public void render(Graphics g){
		...
		Font textBox3 = new Font("arial", 1, 12);
		...
		g.drawString("Money: " + game.getMoney(), 14, 27);
		...
		if(selected == SELECTED.None){
			...
			g.setColor(Color.white);
			g.setFont(textBox);
			g.drawString("How to navigate the upgrade screen:", 265, 180);
			g.setFont(textBox3);
			g.drawString("Click on the boxes to the left to open up upgrade details", 290, 215);
			g.drawString("These boxes will also show your current upgrade level", 290, 255);
			g.drawString("Clicking a box allows you to purchase it to the right", 290, 295);
			g.drawString("The purchase box will appear green if you have enough money", 290, 335);
			g.drawString("Other wise the purchase box will be red", 290, 375);
		}
