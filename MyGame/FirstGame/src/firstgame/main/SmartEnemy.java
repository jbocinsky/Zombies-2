...
public class SmartEnemy extends GameObject {
	...
	public SmartEnemy(float x, float y, ID id, Handler handler) {
		...
		r = new Random();
		randomSpeedConst = (float)(r.nextInt(15))/7;  // Settingss handle enemies overlapping each other and essentially becoming one enemy, slightly randomizes their speed by this constant
	}
	
	//sets random speed to avoid clumping of smart enemies
	public float setRandomSpeed(){
		float baseSpeed = 1.2f; // base speed of the smart enemy
